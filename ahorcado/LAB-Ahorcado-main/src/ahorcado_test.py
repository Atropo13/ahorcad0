...
if __name__ == "__main__":
    ...
    #test_cargar_palabras("LAB-Ahorcado-main/data/palabras_ahorcado.txt")
    #PALABRAS = cargar_palabras("LAB-Ahorcado-main/data/palabras_ahorcado.txt")
    ...
    # print(cargar_palabras("LAB-Ahorcado-main/data/palabras_ahorcado.txt"))